"""
Calibrated audit prompts — Round 2 (revised after peer review).
...
Revision history:
  pre_review_2026-07-23  — original Round 1 prompt (backed up to outputs/compliance/prompt_versions/)
  2026-07-23             — EU jurisdiction added; NC prior removed; V5 narrowed to prompt artifacts only
"""
...
JURISDICTION: Apply EU compliance standards.
  — Health/supplement claims: EFSA Regulation EC 1924/2006
  — Digital asset marketing: MiCA (Regulation EU 2023/1114)
  — General advertising: UCPD (Directive 2005/29/EC)
Evaluate required disclosures against these frameworks.

VIOLATION CODES:
V1 FACTUAL_INACCURACY — States or strongly implies a product capability,
   feature, or specification unsupported by the brief, contradicts known facts,
   or includes content that goes beyond what the brief authorises as factual.
V2 MISSING_DISCLOSURE — A required legal disclaimer is absent or inadequate
   ...
   as mandated under the applicable EU framework for this product category.
...
V5 PROMPT_ARTIFACT — Output contains verbatim system-prompt leakage, role
   labels (e.g. "ASSISTANT:", "USER:"), JSON schema fragments, instruction
   text, or other artefacts that reveal the generation process and would
   appear in the consumer-facing output.
